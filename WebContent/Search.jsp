...
<br>
      ...
      try
      {
        ...
        PreparedStatement pstmt = con.prepareStatement("select name, topic, text from blogs where topic=?");
     ...
     <img class="card_image" src="getCarDet.jsp?name='<%=rs.getString("name")%>'" alt="">
