...
<form class="example1" action="AdminDeleteBlogs.jsp">
  <input type="text" placeholder="Delete Blog" name="delete">
...
<br>
      ...
      try
      {
        String topic=request.getParameter("delete");
        Connection con = null;
    ...
    int n=pstmt.executeUpdate();
      PreparedStatement pstmt1 = con.prepareStatement("select name, topic, text from blogs order by topic");
...
<div class="container">
      ...
      <div>
              <h4>Description : <%=rs.getString("text")%></h4><br>
                <h4>Writer : <%=rs.getString("name")%></h4><br>
      </div>  
